<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分成比例" align="center" prop="splitRatio">
        <template #default="scope">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" @click="handleDetail(scope.row)"
            v-hasPermi="['manage:partner:query']">详情</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="partnerRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="分成比例" prop="splitRatio">
          <el-input v-model="form.splitRatio" placeholder="请输入分成比例" />
        </el-form-item>
    ...
    <!-- 查看合作商详情对话框 -->
    <el-dialog title="合作商详情" v-model="detailOpen" width="800px" append-to-body>
      <div class="dialog-content">
        <el-row :gutter="20" style="margin-bottom: 20px;">
          <el-col :span="12" class="info-item">合作商名称：{{ form.partnerName }}</el-col>
          <el-col :span="12" class="info-item">合作商账号：{{ form.account }}</el-col>
        </el-row>
        <el-row :gutter="20" style="margin-bottom: 20px;">
          <el-col :span="12" class="info-item">联系人：{{ form.contactPerson }}</el-col>
          <el-col :span="12" class="info-item">联系电话：{{ form.contactPhone }}</el-col>
        </el-row>
        <el-row :gutter="20" style="margin-bottom: 20px;">
          <el-col :span="12" class="info-item">分成比例：{{ form.splitRatio }}%</el-col>
          <el-col :span="12" class="info-item">备注：{{ form.remark }}</el-col>
        </el-row>
        <el-row :gutter="20" style="margin-bottom: 20px;">
          <el-col :span="12" class="info-item">创建时间：{{ form.createTime }}</el-col>
          <el-col :span="12" class="info-item">创建人：{{ form.createBy }}</el-col>
        </el-row>
        <el-row :gutter="20" style="margin-bottom: 20px;">
          <el-col :span="12" class="info-item">最后更新时间：{{ form.updateTime }}</el-col>
          <el-col :span="12" class="info-item">最后更新人：{{ form.updateBy }}</el-col>
        </el-row>
      </div>
    </el-dialog>
  </div>
...
function handleResetPwd(row) {
  ...
  proxy.$modal.confirm('是否确认重置合作商管理编号为"' + _id + '"的密码？').then(function() {
    ...
    getList();
    proxy.$modal.msgSuccess("重置成功，新密码为：123456");
  }).catch(()=> {});
}
