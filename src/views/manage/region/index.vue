  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="regionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary"  @click="listRegionInfo(scope.row)" v-hasPermi="['manage:region:list']">查看详情</el-button>
...
function listRegionInfo(row) {
  ...
  /** 获取区域下的点位列表 */
  partQry.regionId = _id;
  listNode(partQry).then(response => {
    regionInfo.value = response.rows;
  });
